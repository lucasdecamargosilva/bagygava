(function () {
    ...
    if (window.__PL_GAVA_LOADED__) { console.log('[PL] Widget Gava já carregado — ignorando duplicata.'); return; }
    window.__PL_GAVA_LOADED__ = true;
    console.log('[PL] Widget Gava carregado | URL:', window.location.pathname);
    // ===============================================
    // 0. CHUMBAR A API KEY AQUI DIRETO NO CÓDIGO
    // ===============================================
    const apiKey = "pl_live_ce9b10385b837e4ec59cc993df425fc5f1f69541e982855460b1b0b53541838f";
    ...
    const WEBHOOK_CHECK_LIMIT = 'https://n8n.segredosdodrop.com/webhook/gava-check-limit';
    ...
    const html = `
        <div id="q-modal-ia">
            <div class="q-card-ia">
                ...
                <div class="q-content-scroll">
                    ...
                    <div id="q-loading-box">
                        <div class="q-loading-texts">
                            ...
                            <a href="https://provoulevou.com.br/?utm_source=widget&utm_medium=parceiro&utm_campaign=gava" target="_blank" rel="dofollow noopener" class="q-loading-t2">
                ...
                <a href="https://provoulevou.com.br/?utm_source=widget&utm_medium=parceiro&utm_campaign=gava" target="_blank" rel="dofollow noopener" class="q-powered-footer">
                    <span>Powered by</span>
            ...
            try {
                ...
                if (pending) {
                    ...
                    const resp = await fetch(WEBHOOK_PIX, {
                        ...
                        body: JSON.stringify({ email: 'cliente@provoulevou.com.br', phone: '55' + phoneInput.value.replace(/\D/g, ''), loja: 'gava', origin: location.origin })
...
const fd = new FormData();
                ...
                console.log('[PL Gava] Enviando', allProdImgs.length, 'fotos do produto');
